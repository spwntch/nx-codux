...
export const ABOUT_CONTENT: IContent = {
  ...
  subheading: {content:`You've just found the partner you've been looking for.`, className:'max-w-xl'},
  body: [
...
export const ABOUT_YOUTUBE = '1xgP-dR4dzI';

export const ABOUT_STATS = [
  { label: 'Projects', value: '2,500+' },
  { label: 'Happy Clients', value: '200+' },
  { label: 'Years of Business', value: '20+' },
  { label: 'Years of Collective Experience', value: '300+' },
];
