  ...
  bullets: [
    {
      ...
      body: ['Engage your team with guided sessions and Miro/Mural templates to define and refine your Ideal Customer Profile collaboratively.'],
      className: 'text-lg mt-2',
    },
    {
      icon: <ClipboardList size={24} />,
      heading: 'Comprehensive Worksheets and Templates',
      body: ['Use practical tools and ready-to-use formats to collect, analyze, and create detailed customer profiles and personas.'],
      className: 'text-lg mt-2',
    },
    {
      icon: <ShieldQuestion size={24} />,
      heading: 'Survey Scripts and Questions',
      body: ['Leverage pre-made scripts and questions for running effective online customer surveys, gathering valuable insights with ease.'],
      className: 'text-lg mt-2',
    },
    {
      icon: <BarChart3 size={24} />,
      heading: 'Data-Driven Insights and Strategies',
      body: ['Transform customer data into actionable strategies, ensuring every decision is backed by precise analytics and thorough customer understanding.'],
      className: 'text-lg mt-2',
    },
  ],
};
